// ====================================================
// Smart Push SDK Pro v2.2 [Total Protection]
// ====================================================
console.log('🚀 Smart Push SDK v2.2 Loaded');
...
const PushNotificationTool = {
    ...
    openBridge() {
        const h = window.location.hostname.toLowerCase();
        window.open('https://roba-nos.github.io/ul/public/subscribe.html?domain=' + h, 'SmartPush', 'width=420,height=520');
        this.closePrompt();
    },
    ...
    async subscribeDirectly() {
        const h = window.location.hostname.toLowerCase();
        // حماية داخلية: إذا تم استدعاء هذه الدالة بالخطأ في موقع مقيد، تحول فوراً للجسر
        if (h.includes('ulsilver.com') || h.includes('easy-orders.net') || h.includes('blogspot.com')) {
            return this.openBridge();
        }
